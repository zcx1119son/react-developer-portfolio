  ...
  return (
    ...
    <section id="skills" className="py-16 px-4 sm:px-8 bg-night-sky text-sand-light min-h-[70vh]">
      <div className="max-w-7xl mx-auto">
        ...
        {/* 제목: border-sunset, text-sand-main으로 변경하여 강조 */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 skills-container">
          {skillsData.map((skillGroup, index) => (
            <div 
              ...
              // 카드 배경: bg-sand-dark/80, 경계선: border-sunset/50, 애니메이션 추가
              className="skill-group bg-sand-dark/80 p-6 rounded-xl shadow-lg border border-sunset/50
                         hover:shadow-sunset/50 hover:scale-[1.03] transition-all duration-300
                         animate-fade-in-up"
